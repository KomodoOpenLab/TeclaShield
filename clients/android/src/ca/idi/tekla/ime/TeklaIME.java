...
public class TeklaIME extends InputMethodService 
    ...
    private TeklaKeyboardView mInputView;
                ...
                case MSG_START_TUTORIAL:
                    if (mTutorial == null) {
                        if (mInputView.isShown()) {
                            mTutorial = new Tutorial(TeklaIME.this, mInputView);
                            mTutorial.start();
                        } else {
    ...
    public View onCreateInputView() {
        mInputView = (TeklaKeyboardView) getLayoutInflater().inflate(
                R.layout.input, null);
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        switch (primaryCode) {
            ...
            case Keyboard.KEYCODE_CANCEL:
                ...
                break;
            case TeklaKeyboardView.KEYCODE_OPTIONS:
                showOptionsMenu();
                break;
            case TeklaKeyboardView.KEYCODE_SHIFT_LONGPRESS:
                if (mCapsLock) {
                    handleShift();
                } else {
                    toggleCapsLock();
    ...
    public void swipeRight() {
        if (TeklaKeyboardView.DEBUG_AUTO_PLAY) {
    ...
    private void launchSettings() {
        ...
        intent.setClass(TeklaIME.this, TeklaIMESettings.class);
    ...
    private void showOptionsMenu() {
        ...
        CharSequence itemInputMethod = "com.android.internal.R.string.inputMethod";
    ...
    class AutoDictionary extends ExpandableDictionary {
        ...
        public void addWord(String word, int addFrequency) {
            ...
            if (freq > PROMOTION_THRESHOLD) {
                TeklaIME.this.promoteToUserDictionary(word, FREQUENCY_FOR_AUTO_ADD);
            }
        }
    }
